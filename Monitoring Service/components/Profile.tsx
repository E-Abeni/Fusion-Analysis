  ...
  return (
    <div className="min-h-screen bg-[#fcfdfe] pb-12">
      ...
      <h2 className="text-lg font-semibold flex items-center gap-2 text-slate-900 dark:text-slate-100 mt-2 mx-10">
        ...
        Profiling Behavior (Total Accounts = {<span className="px-2.5 py-1 bg-slate-100 rounded text-green-100 font-black">{Number(profileCount).toLocaleString(undefined, { maximumFractionDigits: 1 })}</span>})
      </h2>
